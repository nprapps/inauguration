...
(function(){window.JST||(window.JST={});window.JST.alert=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<div class="alert '+(alert.klass)+'" data-expires="'+(alert.expires)+'">\n  <button type="button" class="close" data-dismiss="alert">&times;</button>\n  <strong>'+(alert.title)+'</strong>&nbsp;'+(alert.text)+'\n</div>';return __p;};window.JST.chat=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<div class="chat-user-entry">\n\t<div class="container">\n\t\t<div class="row">\n\t\t\t<div class="span12">\n\n\t\t\t\t<div class="chat-login">\n\t\t\t\t\t<div class="form-inline">\n\t\t\t\t\t\t\n\t\t\t\t\t\t<label for="social">Sign in to chat:</label>\n\t\t\t\t\t\t<div class="social btn-group">\n\t\t\t\t\t\t\t<button class="btn btn-mini npr">NPR</button>\n\t\t\t\t\t\t\t<button class="btn btn-mini oauth" data-service="facebook">Facebook</button>\n\t\t\t\t\t\t\t<button class="btn btn-mini oauth" data-service="google">Google</button>\n\t\t\t\t\t\t\t<button class="btn btn-mini anon">Anonymous</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\t\t\t\t\t\t<p class="register-npr"><a href="http://www.npr.org/templates/reg/" target="_blank">Register with NPR</a></p>\n\t\t\t\t\n\t\t\t\t\t\t<div class="chat-anonymous-login">\n\t\t\t\t\t\t\t<label>Chat name:\n\t\t\t\t\t\t\t\t<input type="text" class="chat-anonymous-username"></input>\n\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t<button class="btn btn-mini btn-info">Login</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t\t\t<div class="chat-npr-login">\n\t\t\t\t\t\t\t<label>E-mail address:\n\t\t\t\t\t\t\t\t<input type="text" class="chat-npr-username"></input>\n\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t<label class="npr">Password:\n\t\t\t\t\t\t\t\t<input type="password" class="chat-npr-password"></input>\n\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t<button class="btn btn-mini btn-info">Login</button>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="chat-editor">\n\t\t\t\t\t<p class="chat-input">\n\t\t\t\t\t\t<label for="chat-content">Your comment:</label>\n\t\t\t\t\t\t<textarea name="chat-content" class="chat-content"></textarea>\n\t\t\t\t\t\t<button class="btn btn-mini chat-post">Post</button>\n\t\t\t\t\t</p>\n\t\t\t\t\t<p class="chat-user-info">You are signed in as <span class="chat-username"></span>. <button class="btn btn-mini chat-logout">Logout</button></p>\n\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n\n<div class="container">\n\t<div class="row">\n\t\t<div class="span3 chat-schedule-wrap">\n\n\t\t\t<div class="chat-schedule">\n\t\t\t\t<h3>Inauguration Day Schedule</h3>\n\t\t\t\t<p><em>(All times Eastern)</em></p>\n\t\t\t\t<ul>\n\t\t\t\t\t<li><span><strong class="time">5 a.m.:</strong> NPR coverage begins with <em>Morning Edition</em></span></li>\n\t\t\t\t\t<li><span><strong class="time">10 a.m.:</strong> NPR special coverage begins</span></li>\n\t\t\t\t\t<li><span><strong class="time">11 a.m. (approx.):</strong> Inauguration chat kicks off with <strong>Nina Totenberg</strong>, legal affairs correspondent</span></li>\n\t\t\t\t\t<li><span><strong class="time">11:30 a.m.:</strong> Swearing-in ceremony</span></li>\n\t\t\t\t\t<li><span><strong class="time">11:40 a.m. (approx.):</strong> Inauguration chat: <strong>Justine Kenin</strong> and <strong>Becky Lettenberger</strong>, producers of NPR\'s "<a href="http://npr.org/postcard">Dear Mr. President</a>" project</span></li>\n\t\t\t\t\t<li><span><strong class="time">After Obama\'s speech:</strong> Inauguration chat: <strong>Gene Demby</strong>, correspondent/blogger on NPR\'s race, ethnicity and culture team</span></li>\n\t\t\t\t\t<li><span><strong class="time">1:15 p.m. (approx.):</strong> Inauguration chat: <strong>Shirish Date</strong>, Washington Desk editor</span></li>\n\t\t\t\t\t<li><span><strong class="time">2 p.m. (approx.):</strong> Inauguration chat: <strong>Matthew Green</strong>, associate professor of politics at Catholic University</span></li>\n\t\t\t\t\t<li><span><strong class="time">2:30 p.m. (approx.):</strong> Inauguration chat: <strong>Julie Rovner</strong>, health policy correspondent</span></li>\n\t\t\t\t\t<li><span><strong class="time">2:35 p.m. (approx.):</strong> Inaugural parade</span></li>\n\t\t\t\t\t<li><span><strong class="time">4 p.m.:</strong> NPR coverage continues on <em>All Things Considered</em></span></li>\n\t\t\t\t\t<li><span><strong class="time">6 p.m.:</strong> Inaugural balls begin</span></li>\n\t\t\t\t\t<li><span><strong class="time">7 p.m.:</strong> NPR evening special</span></li>\n\t\t\t\t</ul>\t\n\t\t\t</div>\n\t\n\t\t</div>\n\t\t<div class="span9 chat-body-wrap">\n\t\n\t\t\t<div class="chat-alerts"></div>\n\n            <div class="chat-body">\n                <img src="img/spinner.gif" class="chat-spinner" />\n            </div>\n\n\t\t</div>\n\t</div>\n</div>\n';return __p;};window.JST.chat_image=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{}){__p+='<div class="chat-post chat-post-image" data-id="'+Id+'" data-timestamp="'+timestamp+'">\n    <div class="chat-post-author-photo">\n    \t';if(Creator.Avatar){;__p+='\n\t\t\t<img src="'+(Creator.Avatar)+'" alt="'+(Creator.Name)+'" />\n\t\t';};__p+='\n\t</div>\n    <p class="chat-post-info">\n    \t<span class="chat-post-author">'+(Creator.Name)+'</span>\n    \t<span class="bullet" aria-hidden="true">&#8226;</span>\n    \t<span class="chat-post-datetime">'+created_string+'</span>\n    </p>\n    <p class="chat-post-content">\n    ';_.each(Media,function(media){;__p+='\n        <img src="'+(media.Url)+'" />\n    ';});;__p+='\n    </p>\n</div>\n';}return __p;};window.JST.chat_text=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{}){__p+='<div class="chat-post chat-post-text'+Highlight+'" data-id="'+Id+'" data-timestamp="'+timestamp+'">\n    <div class="chat-post-author-photo">\n    \t';if(Creator.Avatar){;__p+='\n\t\t\t<img src="'+(Creator.Avatar)+'" alt="'+(Creator.Name)+'" />\n\t\t';};__p+='\n\t</div>\n    <p class="chat-post-info">\n    \t<span class="chat-post-author">'+(Creator.Name)+'</span>\n    \t<span class="bullet" aria-hidden="true">&#8226;</span>\n    \t<span class="chat-post-datetime">'+created_string+'</span>\n    </p>\n    <p class="chat-post-content">'+Content+'</p>\n</div>\n';}return __p;};window.JST.photo_modal=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<div class="modal-wrap">\n\n\t<div class="modal-body">\n\t\t<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>\n\t\t<div class="modal-photo"><img src="'+(photo.photo_url_250)+'" class="photo" /></div>\n\t\n\t\t<div class="modal-caption">\n\t\t\t'+(photo.text)+'\n\t\t</div>\n\t</div>\n\t\n\t<div class="modal-nav">\n\t\t<a href="javascript:;" class="navigate nav-back" data-photo="'+previous+'"><span>&lsaquo; Previous</span></a>\n\t\t<a href="javascript:;" class="navigate nav-next" data-photo="'+next+'"><span>Next &rsaquo;</span></a>\n\t</div>\n\n</div>';return __p;};window.JST.widget=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<p></p>';return __p;};window.JST.widget_text=function(obj){var __p='';var print=function(){__p+=Array.prototype.join.call(arguments,'');};with(obj||{})__p+='<span class=\'heading\'>Latest In The Chat</span>\n<span class=\'author\'>'+(post.Creator.Name)+':</span>\n<span class=\'post\'>'+(post.Content)+'</span>\n';return __p;};})();
(function($){$.livechatwidget=function(element,options){var defaults={scribble_host:'apiv1.scribblelive.com',chat_id:null,chat_token:null,update_interval:1000,max_text_length:80};var plugin=this;plugin.settings={};plugin.$root=$(element);var chat_url=null;var update_timer=null;var last_post_timestamp=null;var paused=false;plugin.init=function(){plugin.$root.html(JST.widget());plugin.settings=$.extend({},defaults,options||{});chat_url='http://'+plugin.settings.scribble_host+'/event/'+plugin.settings.chat_id+'/all/?Token='+plugin.settings.chat_token+'&format=json';plugin.$post=plugin.$root.find('p');plugin.update_live_chat();};plugin.pause=function(new_paused){plugin.paused=new_paused;if(plugin.paused)clearInterval(plugin.update_timer);else plugin.update_live_chat();};plugin.update_live_chat=function(){$.ajax({url:chat_url+'&Max=10&Order=desc',dataType:'jsonp',cache:false,success:function(data){var posts_length=data.Posts.length;for(i=0;i<posts_length;i++){var post=data.Posts[i];if(post.Type==='TEXT'){var m=moment(post.Created);var timestamp=parseInt(m.valueOf(),10);if(last_post_timestamp&&last_post_timestamp>timestamp)break;plugin.render_post(post);last_post_timestamp=timestamp;break;}}}}).then(function(){if(!plugin.paused)plugin.update_timer=setTimeout(plugin.update_live_chat,plugin.settings.update_interval);});};plugin.render_post=function(post){if(post.Content.length>plugin.settings.max_text_length)post.Content=$.trim(post.Content.slice(0,plugin.settings.max_text_length))+'&hellip;';var template=JST.widget_text({post:post});plugin.$post.html(template);};plugin.init();};$.fn.livechatwidget=function(options){return this.each(function(){if($(this).data('livechatwidget')===undefined){var plugin=new $.livechatwidget(this,options);$(this).data('livechatwidget',plugin);}});};}(jQuery));
$(function(){$('#live-chat-widget').livechatwidget({chat_id:'74796',chat_token:'FtP7wRfX',update_interval:10000});if($(window).width()<500)$('body').addClass('skinny');});